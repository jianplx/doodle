...
void R_Config_UARTA1_Create(void)
{
    ...
    UTA0CK |= _30_UARTA_FSEL_SELECT_FIMP;
    UTA1CK = _00_UARTA1_SELECT_FSEL;
    /* Set TxDA1 pin */
    PMCA12 &= 0xFEU;
    P12 |= 0x01U;
    PM12 &= 0xFEU;
...
void R_Config_UARTA1_Start(void)
{
    ...
    UARTAEN1 = 1U;
    UTA1CK_bit.no7 = 0U;    /* disables CLKA1 output */
    TXEA1 = 1U;
...
void R_Config_UARTA1_9600(void)
{
    UARTAEN1 = 0U;
    UTMK1 = 1U;    /* disable INTUT1 interrupt */
    UTIF1 = 0U;    /* clear INTUT1 interrupt flag */
...
void R_Config_UARTA1_19200(void)
{
    UARTAEN1 = 0U;
    UTMK1 = 1U;    /* disable INTUT1 interrupt */
    UTIF1 = 0U;    /* clear INTUT1 interrupt flag */
