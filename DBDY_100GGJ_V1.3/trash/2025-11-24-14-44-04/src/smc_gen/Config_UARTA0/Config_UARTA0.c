...
void R_Config_UARTA0_Create(void)
{
    ...
    UTPR10 = 1U;
    UTPR00 = 1U;
    /* Set INTUR0 high priority */
    URPR10 = 0U;
    URPR00 = 0U;
    BRGCA0 = _D0_UARTA_OUTPUT_BAUDRATE;
    ...
    UTA0CK = _30_UARTA_FSEL_SELECT_FIMP | _00_UARTA0_SELECT_FSEL;
    /* Set TxDA0 pin */
    PMCT7 &= 0xFBU;
    PFOE1 |= 0x10U;
    P7 |= 0x04U;
...
void R_Config_UARTA0_Start(void)
{
    ...
    UARTAEN0 = 1U;
    UTA0CK_bit.no7 = 0U;    /* disables CLKA0 output */
    TXEA0 = 1U;
