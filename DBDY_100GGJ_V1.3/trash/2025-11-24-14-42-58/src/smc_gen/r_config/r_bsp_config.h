...
#define BSP_CFG_OPTBYTE2_VALUE (0xE0U) /* Generated value. Do not edit this manually */
...
*/
#define BSP_CFG_X1_WAIT_TIME_SEL (5) /* Generated value. Do not edit this manually */
