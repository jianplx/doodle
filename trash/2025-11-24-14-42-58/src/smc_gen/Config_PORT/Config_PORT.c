...
void R_Config_PORT_Create(void)
{
    ...
    /* Set PORT0 registers */
    PU0 = _02_PUn1_PULLUP_ON | _01_PUn0_PULLUP_ON;
    PIM0 = _00_PIMn1_TTL_OFF;
    PDIDIS0 = _00_PDIDISn0_INPUT_BUFFER_ON;
    PMCT0 = _00_PMCTn1_DIGITAL_ON | _00_PMCTn0_DIGITAL_ON;
    PMCE0 = _00_PMCEn1_DIGITAL_ON;
    PM0 =  _FC_PM0_DEFAULT | _02_PMn1_MODE_INPUT | _01_PMn0_MODE_INPUT;
    /* Set PORT1 registers */
    ...
    PU3 = _02_PUn1_PULLUP_ON | _00_PUn0_PULLUP_OFF;
    PMCT3 = _00_PMCTn1_DIGITAL_ON | _00_PMCTn0_DIGITAL_ON;
    PM3 =  _FC_PM3_DEFAULT | _02_PMn1_MODE_INPUT | _00_PMn0_MODE_OUTPUT;
    /* Set PORT4 registers */
    PU4 = _02_PUn1_PULLUP_ON | _01_PUn0_PULLUP_ON;
    /* Set PORT5 registers */
    P5 = _00_Pn1_OUTPUT_0 | _00_Pn0_OUTPUT_0;
    ...
    PM5 =  _FC_PM5_DEFAULT | _00_PMn1_MODE_OUTPUT | _00_PMn0_MODE_OUTPUT;
    /* Set PORT6 registers */
    P6 = _00_Pn3_OUTPUT_0 | _00_Pn2_OUTPUT_0 | _00_Pn1_OUTPUT_0 | _00_Pn0_OUTPUT_0;
    PMCE6 = _00_PMCEn1_DIGITAL_ON | _00_PMCEn0_DIGITAL_ON;
    PM6 =  _F0_PM6_DEFAULT | _08_PMn3_MODE_INPUT | _04_PMn2_MODE_INPUT | _00_PMn1_MODE_OUTPUT | _00_PMn0_MODE_OUTPUT;
    /* Set PORT7 registers */
    P7 = _00_Pn5_OUTPUT_0 | _00_Pn4_OUTPUT_0 | _00_Pn3_OUTPUT_0 | _00_Pn2_OUTPUT_0 | _00_Pn1_OUTPUT_0 | 
         _00_Pn0_OUTPUT_0;
    PU7 = _20_PUn5_PULLUP_ON | _10_PUn4_PULLUP_ON | _00_PUn3_PULLUP_OFF | _04_PUn2_PULLUP_ON | _02_PUn1_PULLUP_ON | 
          _00_PUn0_PULLUP_OFF;
    ...
    PMCT7 = _00_PMCTn5_DIGITAL_ON | _00_PMCTn4_DIGITAL_ON | _00_PMCTn3_DIGITAL_ON | _00_PMCTn2_NOT_USE | 
            _00_PMCTn1_NOT_USE | _00_PMCTn0_DIGITAL_ON;
    PM7 = _C0_PM7_DEFAULT | _20_PMn5_MODE_INPUT | _10_PMn4_MODE_INPUT | _00_PMn3_MODE_OUTPUT | _04_PMn2_NOT_USE | 
          _02_PMn1_NOT_USE | _00_PMn0_MODE_OUTPUT;
    /* Set PORT12 registers */
    PU12 = _00_PUn2_PULLUP_OFF | _00_PUn1_PULLUP_OFF | _01_PUn0_PULLUP_ON;
    ...
    PU14 = _00_PUn7_PULLUP_OFF | _00_PUn6_PULLUP_OFF | _01_PUn0_PULLUP_ON;
    ...
    PTDC = _00_P17_OUTPUT_MAX_CURRENT_20mA | _00_P51_OUTPUT_MAX_CURRENT_20mA | _00_P70_OUTPUT_MAX_CURRENT_20mA;
