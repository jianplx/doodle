...
Macro definitions
***********************************************************************************************************************/
#define _04AF_TAU_TDR02_VALUE                              (0x04AFU)    /* 16-bit timer data register 02 (TDR02) */
#define _0258_TAU_TDR03_VALUE                              (0x0258U)    /* 16-bit timer data register 03 (TDR03) */
#define _0258_TAU_TDR04_VALUE                              (0x0258U)    /* 16-bit timer data register 04 (TDR04) */
#define _0258_TAU_TDR05_VALUE                              (0x0258U)    /* 16-bit timer data register 05 (TDR05) */
#define _0258_TAU_TDR06_VALUE                              (0x0258U)    /* 16-bit timer data register 06 (TDR06) */
#define _0258_TAU_TDR07_VALUE                              (0x0258U)    /* 16-bit timer data register 07 (TDR07) */
